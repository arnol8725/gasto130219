...
@Component({
  ...
  selector: 'dialog-data-ingresoADN-dialog',
  templateUrl: '../views/dialog-data-ingresoADN-dialog.html',
  providers: [    
    ProductoService,
  ],
})
export class DialogDataIngresoADNDialog {
                                          ...
                                          result => {
                                            ...
                                            if(result.code != 200){
                                              ...
                                              console.log('Entro');                                           
                                                        ...
                                                        console.log('Se presento un error al guardar la solicitud');
                                                        this.titulo="Error";
                                                        this.mensaje= 'Error al egresar solicitud';
                                                       this.pantalla=true; 
                                                       this.PantallaImprimir=false;
                                                       this.boton=true;
                                                       this.retornar=false;
                                            ...
                                            if(result.code != 200){
                                              ...
                                              console.log('Entro');
                                                  ...
                                                  $('.mat-dialog-container').css({'width': '100%','height': '100%','max-width':'80vw'});
                                                        console.log('Se presento un error al guardar la solicitud');
                                                        this.titulo="Error";
                                                        this.mensaje= 'Error al obtener informaciión para el ticket';
                                                       this.pantalla=true; 
                                                       this.PantallaImprimir=false;
                                                       this.boton=true;
                                                       this.retornar=false;
            ...
            $('.mat-dialog-container').css({'width': '25%','height': '150px','margin':'auto'});
              ...
              /*Metodos para realizar la impresion*/
               ...
               console.log(this.data.generales);
                       ...
                       this._productoService2.setArchivoImprimiringresarADN(this.datosGenerales,this.ticket).subscribe(
                          result => {
                                 console.log('RESULTADO');
                                 console.log(result);
